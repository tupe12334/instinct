---
name: spin-selling
description: "Guide sales conversations through Situation, Problem, Implication, and Need-Payoff questions to surface and grow buyer need."
version: 1.0.0
platforms: [linux, macos, windows]
metadata:
  hermes:
    tags: [spin, selling, sales, questions, needs, implication, problem]
    related_skills: [jobs-to-be-done, value-proposition-canvas, star-method]
---
