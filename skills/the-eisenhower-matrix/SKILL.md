...
description: "Prioritize tasks by urgency and importance into Do, Schedule, Delegate, Eliminate."
version: 1.0.0
...
- Confusing **urgency** (time pressure) with **importance** (strategic value) — urgent ≠ important
- Letting Q3 (others' urgencies) crowd out Q2 (your priorities)
- Keeping Q4 items instead of eliminating them
